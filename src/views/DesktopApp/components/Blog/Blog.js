...
const Blog = () => {
  ...
  const LeftSide = () => (
    <Box>
      ...
      >
        "Unlock the Full Potential of Your Blog with Trafficlead! Are you
        looking to supercharge your blog's visibility and reach a wider
        audience? Look no further than Trafficlead, your go-to solution for
        targeted and high-quality traffic. Our innovative service is designed to
        drive real visitors to your blog, boosting engagement, and skyrocketing
